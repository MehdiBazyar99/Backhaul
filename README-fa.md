...
### **بهبودهای اخیر**
- ✅ **رفع اشکالات اساسی و بهبود تجربه کاربری (v14.0-dev)**: رفع اشکالات حیاتی در تولید فایل TOML و مدیریت مسیر گواهی TLS. راهنمای فوروارد پورت به صورت تعاملی بازنویسی شد.
- ✅ **بازسازی عمده کد (v14.0-dev)**: بازسازی داخلی قابل توجه تمام ماژول‌های اسکریپت برای بهبود قابلیت نگهداری، استحکام و استانداردسازی توابع کمکی. این بازسازی همچنین اشکالات و ناسازگاری‌های مختلف را برطرف کرد.
- ✅ **ریستارت هوشمند**: ریستارت پیشرفته با بررسی سلامت و نظارت بر منابع
